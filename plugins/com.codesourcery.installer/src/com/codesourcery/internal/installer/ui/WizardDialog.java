 ...
 *     Mentor Graphics - Modified to use different progress reporting in installer
 *******************************************************************************/
 ...
 * </p>
 */
// Mentor Graphics: Suppress warnings from original Eclipse code
@SuppressWarnings({ "rawtypes", "unchecked" })
public class WizardDialog extends TitleAreaDialog implements IWizardContainer2,
		IPageChangeProvider {
	
	// Mentor Graphics:  This class was copied from Eclipse in order to expose
	...
	protected Control createDialogArea(Composite parent) {
		...
		// Mentor Graphics: Remove and use progress part from wizard page
